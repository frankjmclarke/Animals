...
data class Animal(
    val name: String?,// under [, top level of each array item
    val taxonomy: Taxonomy?,
    val location: String?,
    val speed: Speed?,
    val diet: String?,

    @SerializedName("lifespan") //different capitalization
    val lifeSpan: String?,
...
data class Taxonomy(
    val kingdom: String?,// under [{, second level of each array item
    val order: String?,
    val family: String?
): Parcelable {
    constructor(parcel: Parcel) : this(
...
data class AnimalPalette(var color: Int)//just for databinding